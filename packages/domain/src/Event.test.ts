...
const _isoDate = (iso: string): Date => DateTime.toDateUtc(DateTime.makeUnsafe(iso))

const createdAt = _isoDate("2026-01-01T00:00:00.000Z")
...
describe("event status transitions", () => {
  test("allows draft to live", () => {
    const result = transitionEventStatus(event, "live", _isoDate("2026-01-02T00:00:00.000Z"))
